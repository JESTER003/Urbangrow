...
export function Hero() {
  ...
  return (
    <div className="relative min-h-[80%] flex items-center justify-center bg-gradient-to-b overflow-hidden">
      {/* Chatbot Floating Button */}
      <div>
        <div
          onClick={handleChatToggle}
          className="p-4 h-20 w-20 bg-red-300 rounded-full fixed z-50 right-6 bottom-6 flex items-center justify-center shadow-lg cursor-pointer"
        >
          <p>Chat</p>
        </div>
        {/* Chat Section */}
        {isChatOpen && (
          <div className="h fixed bottom-20 right-6 w-150 bg-white rounded-lg shadow-xl z-50">
            <div className="flex justify-between items-center bg-red-300 p-3 rounded-t-lg">
            ...
            <div className="p-4 h-64 overflow-y-auto">
              ...
              <div className="text-gray-600 mb-2">
                <p><strong>Urbagrow : </strong> Hello! How can I assist you today?</p>
              </div>
              {/* Input */}
              <div className="mt-4 flex">
                ...
                />
                <button className="bg-red-300 text-white px-4 py-2 rounded-r-lg hover:bg-red-400">
                  Send
                </button>
              </div>
            </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 flex flex-col lg:flex-row items-center">
        ...
        >
          ...
          >
            <Link to="/Learn">
              <button
                className="bg-emerald-600 hover:bg-emerald-500 text-white text-lg px-6 py-3 rounded-md font-bold group"
              >
                Start Growing
            ...
            <button
              className="border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-50 text-lg px-6 py-3 rounded-md font-bold"
            >
              Meet Our Mentors
            </button>
          </motion.div>
